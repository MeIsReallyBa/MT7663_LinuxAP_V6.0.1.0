...
#if defined(RLM_CAL_CACHE_SUPPORT) || defined(PRE_CAL_TRX_SET2_SUPPORT) || defined(PRE_CAL_MT7622_SUPPORT) || defined(PRE_CAL_MT7663_SUPPORT)
...
)
{
	...
	/* Check G-Band/A-Band */
	u1PwrLimitChannel = (u1ChannelBand) ? (u1ControlChannel) : (u1CentralChannel);

	if (u1ChannelBand == 0) { /* Not 802.11j */
	...
	MtPwrFillLimitParam(pAd, u1PwrLimitChannel, u1ChannelBand, &rPwrLimitTblCtrl.uPwrLimitTbl, u1Type);
