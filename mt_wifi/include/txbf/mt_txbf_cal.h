...
#define IBF_LNA_PHASE_G1_ADDR       (IBF_LNA_PHASE_G0_ADDR  + 0x0C)
#define IBF_LNA_PHASE_G2_ADDR       (IBF_LNA_PHASE_G1_ADDR  + 0x0C)
#define IBF_LNA_PHASE_G3_ADDR       (IBF_LNA_PHASE_G2_ADDR  + 0x0C)
#define IBF_LNA_PHASE_G4_ADDR       (IBF_LNA_PHASE_G3_ADDR  + 0x0C)
#define IBF_LNA_PHASE_G5_ADDR       (IBF_LNA_PHASE_G4_ADDR  + 0x0C)
#define IBF_LNA_PHASE_G6_ADDR       (IBF_LNA_PHASE_G5_ADDR  + 0x0C)
#define IBF_LNA_PHASE_G7_ADDR       (IBF_LNA_PHASE_G6_ADDR  + 0x0C)
#define IBF_LNA_PHASE_G8_ADDR       (IBF_LNA_PHASE_G7_ADDR  + 0x0C)
#else
#define IBF_PHASE_EEPROM_START      0x320
...
#if defined(MT7663)
typedef struct _MT7663_IBF_PHASE_OUT {
	UINT8 ucC0_L;
	UINT8 ucC1_L;
	UINT8 ucC2_L;
	UINT8 ucC3_L;
	...
	UINT_8 ucC2_UH;
	UINT_8 ucC3_UH;
} MT7663_IBF_PHASE_OUT, *P_MT7663_IBF_PHASE_OUT;

typedef struct _MT7663_IBF_PHASE_G0_T {
	UINT_8 ucG0_R0_UH;
	UINT_8 ucG0_R0_H;
	UINT_8 ucG0_R0_M;
	UINT_8 ucG0_R0_L;
	...
	UINT_8 ucG0_M_T0_H;
	UINT_8 ucG0_M_T1_H;
} MT7663_IBF_PHASE_G0_T, *P_MT7663_IBF_PHASE_G0_T;

typedef struct _MT7663_IBF_PHASE_Gx_T {
	UINT_8 ucGx_R0_UH;
	UINT_8 ucGx_R0_H;
	UINT_8 ucGx_R0_M;
	UINT_8 ucGx_R0_L;
	...
	UINT_8 ucGx_M_T0_H;
	UINT_8 ucGx_M_T1_H;
} MT7663_IBF_PHASE_Gx_T, *P_MT7663_IBF_PHASE_Gx_T;
#endif
...
#if defined(MT7663)
VOID mt7663_eBFPfmuMemAlloc(IN struct _RTMP_ADAPTER *pAd,
						IN PCHAR pPfmuMemRow,
						IN PCHAR pPfmuMemCol);

VOID mt7663_iBFPfmuMemAlloc(IN struct _RTMP_ADAPTER *pAd,
						IN PCHAR pPfmuMemRow,
						IN PCHAR pPfmuMemCol);
#endif /* MT7663 */
